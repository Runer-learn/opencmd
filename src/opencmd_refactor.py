...
parser.add_argument('-h','--help'); # 帮助
parser.add_argument('-v','--version'); # 获取版本号
parser.add_argument('-o','-O','--open'); # 打开指定项的控制台
parser.add_argument('-oe','-OE','--opene'); # 打开指定项的文件浏览器
parser.add_argument('-a','-A','--add'); # 新增加一个配置项
parser.add_argument('-r','-R','--read'); # 读取配置项
parser.add_argument('-d','-D','--delete'); #删除指定项
